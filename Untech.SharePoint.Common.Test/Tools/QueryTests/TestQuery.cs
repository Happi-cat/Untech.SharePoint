...
namespace Untech.SharePoint.Common.Test.Tools.QueryTests
{
	...
	{
		public TestQuery(Func<IQueryable<T>, object> query, IEqualityComparer<TResult> comparer = null, Type exception = null, string caml = null)
		{
			Query = query;
		...
		{
			executor.Visit(Query, Comparer, Exception, Caml);
		}
	}
}